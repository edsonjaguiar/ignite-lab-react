    ...
    return (
        <div className="flex-1">
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16 flex-col md:flex-row">
                    ...
                    <div className="flex flex-col gap-4">
                        <a
                            href=""
                            target="_blank"
                            className="p-4 text-sm bg-green-500 flex items-center rounded font-bold uppercase gap-2 justify-center hover:bg-green-700 transitions-colors"
                        >
                            <DiscordLogo size={24} />
                ...
                <div className="gap-8 mt-20 grid grid-rows md:grid-cols-2">
                    <a
                        href=""
